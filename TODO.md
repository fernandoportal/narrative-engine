...
- [x] Document storytelling frameworks and implementation guidance
- [x] Document AI collaboration rules and continuity safeguards
...
- [ ] Add scene objective tracking across episodes and acts
- [ ] Add project health scorecard (theme coherence, pacing, payoff coverage)
...
- [ ] Story pack marketplace format for reusable world kits
- [ ] Integration recipes for common AI writing assistants
- [ ] Automated changelog assistant for decision logging
- [ ] Experimental timeline visualizer for nonlinear narratives
