...
Narrative Engine is optimized for human + AI narrative development. This guide
defines how AI assistants should operate inside this repository.

## Core Operating Rules

1. Preserve continuity before adding novelty.
2. Make modular edits; do not rewrite the full project unless explicitly
   requested.
...
2. `story/themes.md` and `story/emotional-logic.md` for thematic/psychological
   intent
...
AI should ask: “Does this edit preserve higher-level intent from authoritative
files?”
...
- Avoid introducing major lore or mechanics without updating `story/world.md`
  and `story/rules.md`
...
> Revise `structure/midpoint.md` and `structure/scene-list.md` to strengthen
> causality after the midpoint. Preserve protagonist motivation and keep tone
> grounded thriller.
