# Project Bible: Narrative Engine
...
A strong story behaves like an integrated system:

- `story/` holds premise, thematic intent, and world assumptions
...
## Story Architecture in This System

Narrative architecture is managed as layered decisions:

1. **Core Intent:** logline, premise, central theme
2. **Human Engine:** wound, want, need, conflict vectors
3. **Plot Mechanics:** act breaks, midpoint, reversals, payoff chains
...
## How to Use for Series

- Define season-level question in `series/season-arc.md`.
- Track episode progression in `series/episode-guide.md`.
- Draft each episode in `series/episodes/`.
- Maintain continuity between season arc and episodic beats.

## How to Use for Storyworld Projects
