...
- Draft act intent in `structure/three-act-structure.md`
- Align key turns in `structure/beat-sheet.md`
- Validate execution in `screenplay/selected-scenes/`
...
**How to use in this repo:**
- Track major beats in `structure/save-the-cat.md`
- Sync catalyst, midpoint, and finale with `structure/beat-sheet.md`
- Check tonal consistency in `story/emotional-logic.md`
...
**How to use in this repo:**
- Map stages in `structure/hero-journey.md`
- Tie each stage to wound/want/need in `characters/character-psychology.md`
- Confirm payoffs in `structure/setup-and-payoff.md`
...
**How to use in this repo:**
- Build event logic in `structure/but-therefore.md`
- Use `structure/scene-list.md` to ensure each scene causes the next
- Fix weak links before screenplay polishing

## Character Wound / Want / Need
**What it is:**
- **Wound:** unresolved emotional injury
- **Want:** conscious objective
- **Need:** deeper transformation requirement

**Why it matters:** Drives behavior and makes arc changes emotionally credible.

**How to use in this repo:**
- Define in `characters/protagonist.md` and `characters/antagonist.md`
- Cross-check with `story/emotional-logic.md`
- Reflect movement at midpoint and finale in `structure/beat-sheet.md`
...
**How to use in this repo:**
- Plan in `structure/pinch-points.md`
- Position around act transitions in `structure/three-act-structure.md`
- Confirm they escalate, not repeat
...
**How to use in this repo:**
- Define in `structure/midpoint.md`
- Reflect consequences in `structure/scene-list.md`
- Mirror character shift in `characters/character-psychology.md`
...
**How to use in this repo:**
- Specify loss type in `structure/all-is-lost.md`
- Connect to wound activation in `story/emotional-logic.md`
- Build rebound logic into final act files
...
**How to use in this repo:**
- Track setups/payoffs in `structure/setup-and-payoff.md`
- Tag callbacks in `screenplay/draft-v1.fountain` and `draft-v2.fountain`
- Verify unresolved setups before release passes
...
**How to use in this repo:**
- Note foreshadowing elements in `structure/setup-and-payoff.md`
- Maintain subtlety through `screenplay/selected-scenes/`
- Keep thematic alignment in `story/themes.md`
...
**How to use in this repo:**
- Define visual motifs in `art/visual-style.md`
- Integrate in Fountain scene action lines
- Ensure trailer concepts reinforce visual identity
...
**How to use in this repo:**
- Design thread purpose in `structure/parallel-storylines.md`
- Track intersections in `series/episode-guide.md` or `structure/scene-list.md`
- Ensure each line alters the central conflict
...
**How to use in this repo:**
- Map mirrors in `structure/emotional-mirroring.md`
- Attach mirrored beats to specific characters in `characters/relationships.md`
- Validate payoff in finale scenes
...
**How to use in this repo:**
- Define constraints in `structure/ticking-clock.md`
- Thread deadlines into `structure/scene-list.md`
- Reflect urgency in dialogue pacing and scene transitions
...
**How to use in this repo:**
- Audit exposition-heavy sections in `screenplay/draft-v1.fountain`
- Move explanatory content into conflict-driven scenes
- Keep world rules concise in `story/rules.md`
...
**How to use in this repo:**
- In `structure/scene-list.md`, state each scene decision and consequence
- Remove passive transitions and convenience outcomes
- Confirm climax resolves through earned character action
...
**How to use in this repo:**
- Define thematic thesis in `story/themes.md`
- Assign expression points across `structure/` and `characters/`
- Check final act delivers a clear thematic stance
